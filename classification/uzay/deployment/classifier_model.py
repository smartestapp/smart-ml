...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           ...
           'wide_resnet50_2', 'wide_resnet101_2'] + ['DenseNet', 'densenet121', 'densenet169', 'densenet201', 'densenet161']
...
def get_model(model_name, num_classes, feature_extract, use_pretrained=True, num_channels=3):
    if model_name == 'resnet18':
        ...
        set_parameter_requires_grad(model, feature_extract)
        if num_channels != 3:
            model.features[0] = nn.Conv2d(in_channels=num_channels,
                                          out_channels=64,
                                          kernel_size=(11, 11),
                                          stride=(4, 4),
                                          padding=(2, 2))
        ...
        set_parameter_requires_grad(model, feature_extract)
        if num_channels != 3:
            model.features.conv0 = nn.Conv2d(in_channels=num_channels,
                                             out_channels=64,
                                             kernel_size=(7, 7),
                                             stride=(2, 2),
                                             padding=(3, 3),
        ...
        raise ValueError('model=%s is not recognized!' % model_name)
...
class ConvolutionalDecoder(nn.Module):
    def __init__(self, img_size, num_channels, hidden_dims, **kwargs):
