...
​
    def __init__(self):
        ...
        self.kit_id = 'oraquick'
        self.model_filename = "%s_classifier.pt" % self.kit_id
        ############################################
​
        self.model = None
        self.mapping = None
...
​
        ############################################ ONLY CONFIGURE THESE IF classifier_model.py is CHANGED!
        """
        class Namespace:
...
​
        self.model = get_model(model_name='resnet18',
                               num_classes=2,
...
​
​
        ############################################ ONLY CONFIGURE THESE IF INPUT ROTATION IS CHANGED!
...
​
        ...
        for idx,zone_key in enumerate(self.loc_split):
            ...
            img_zone.append(F.upsample(img_memb[:,:,int(pos['y']*480):int(pos['y']*480)+int(pos['h']*480), :],size=[64, 64],mode='bilinear'))
