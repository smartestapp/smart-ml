...
def lambda_handler(event, context):
	...
	# Upload initial data
	upload_file(global_id=start_time, filename='initial_image.jpg', data=array_to_bytes(image_array=initial_image))
	...
	# Upload warped data
	upload_file(global_id=start_time, filename='kit_warped_image.jpg', data=array_to_bytes(image_array=kit_warped_image))
	...
	if overlap_percentage < MEMBRANE_LOCALIZATION_THRESHOLD:
		...
		upload_file(global_id=start_time, filename='unlocalized_rotated_membrane.jpg', data=array_to_bytes(image_array=kit_warped_image[membrane_ymin: membrane_ymax, membrane_xmin: membrane_xmax, :]))
	...
	upload_file(global_id=start_time, filename='rotated_membrane.jpg', data=array_to_bytes(image_array=membrane))
	...
	upload_file(global_id=start_time, filename='best_rotated_membrane.jpg', data=array_to_bytes(image_array=membrane))
